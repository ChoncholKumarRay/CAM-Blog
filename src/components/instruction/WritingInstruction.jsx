...
const WritingInstruction = () => {
  ...
  return (
    <section className="font-bangla">
      ...
      <ol className="list-decimal list-inside space-y-4 text-gray-200 leading-relaxed">
        <li>
          ...
          সেক্ষেত্রে লেখার পূর্বেই আমাদের অবহিত করতে হবে। গৃহীত হলে ঐ টপিক নিয়ে
          লিখা পাঠাতে পারবেন।
        </li>
        <li>
        ...
        <li>
          প্রবন্ধে কোনো ছবি যুক্ত করতে চাইলে অবশ্যই ছবির মূল উৎস (source) উল্লেখ
          করতে হবে। এছাড়া প্রয়োজনীয় ক্যাপশন যুক্ত করতে হবে।
        </li>
        <li>
